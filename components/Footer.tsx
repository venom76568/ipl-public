        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="flex flex-col items-center">
              <Image
                ...
                alt="logo"
              />
              <div className="max-w-xs scale-125 text-base mt-4 text-[12px] text-white">
          ...
          <div className="grid grid-cols-1 gap-8 lg:col-span-2 lg:grid-cols-3 md:scale-90 lg:scale-95 xl:scale-100">
            ...
            <div className="flex flex-col items-center gap-2">
              <p className="font-bold text-lg xl:text-xl">In case of any query contact</p>
